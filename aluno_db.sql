...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Ago-2021 às 10:01
...
(33, '23', 'Gabriela', 2, 2, 2, 2),
(34, '23', 'Rodrigo', 1, 1, 1, 1),
...
--
ALTER TABLE `aluno`
  MODIFY `idAluno` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
